...
/**
 * Version information for PLUGINTYPE_PLUGINNAME -- MOODLE_502_STABLE line.
 *
...
// Pinned to Moodle 5.2.0's own GA version.php build number (verified against
// https://moodledev.io/general/releases/5.2 on 2026-08-09, using Moodle's own
// YYYYMMDDXX convention for the release date). Raising this only makes sense
// if this branch later needs a floor somewhere inside the 5.2.x line --
